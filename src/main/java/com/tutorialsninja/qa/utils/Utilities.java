...
public class Utilities {
	...
	public static String generateUniqueMailForTest() {

		Date date = new Date();
		String timestamp = date.toString().replace(" ", "_").replace(":", "_");
		return "yejipo" + timestamp + "@gmail.com";

	}

	public static Object[][] getTestDataFromExcel(String sheetName) throws Throwable {
		
		File excelFile = new File(System.getProperty("user.dir")
				+ "\\src\\main\\java\\com\\tutorialsninja\\qa\\testdata\\Tutorialninjatestdata.xlsx");
	...
	public static String getScreenshot(WebDriver driver, String testname) {
		...
		File  destination = new File(destinationScreenshotPath);
		try {
